...
namespace Lich
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            textBox1.Text = d1.Year.ToString();
            textBox2.Text = "Tháng "+d1.Month.ToString();
            textBox3.Text = d1.Day.ToString();
            textBox4.Text = "Thứ "+d1.Day.ToString();
            int[] ngayam = convertSolar2Lunar(d1.Day, d1.Month, d1.Year, 7);
            textBox5.Text = new DateTime(ngayam[2], ngayam[1], ngayam[0]).ToString("dd/MM/yyyy");
            textBox6.Text = "Tính theo âm lịch";
        }
